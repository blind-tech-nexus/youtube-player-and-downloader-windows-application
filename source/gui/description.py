...
class DescriptionDialog(wx.Dialog):
	def __init__(self, parent, content):
		wx.Dialog.__init__(self, parent, title="Video description", size=(500, 500))
		self.Centre()
		self.content = content
		panel = wx.Panel(self)
		lbl = wx.StaticText(panel, -1, "Description: ")
		...
		copyButton = wx.Button(panel, -1, "Copy", name="export")
		txtExport = wx.Button(panel, -1, "Export to text document (txt)...", name="export")
		htmlExport = wx.Button(panel, -1, "Export to web page (html)...", name="export")
		closeButton = wx.Button(panel, wx.ID_CANCEL, "Close")
