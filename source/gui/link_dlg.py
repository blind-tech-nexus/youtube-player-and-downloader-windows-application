...
class LinkDlg(wx.Dialog):
	def __init__(self, parent):
		...
		lbl = wx.StaticText(panel, -1, "Video link")
		self.link = wx.TextCtrl(panel, -1, value="")
		self.mode = wx.RadioBox(panel, -1, "Play as: ", choices=["Video", "Audio"])
		self.okButton = wx.Button(panel, wx.ID_OK, "Play")
		self.okButton.SetDefault()
		cancelButton = wx.Button(panel, wx.ID_CANCEL, "Close")
